...
// === 插针形态分析 ===
// 计算影线比例
getShadowRatio(float open, float high, float low, float close) =>
...
isUpperPin = upperShadow > lowerShadow * 2 and upperShadow > ta.atr(10) * 0.5
isLowerPin = lowerShadow > upperShadow * 2 and lowerShadow > ta.atr(10) * 0.5
...
// 计算综合得分
float signalQuality = (trendScore + volumeScore + momentumScore + pinScore) / 4.0 * 100
